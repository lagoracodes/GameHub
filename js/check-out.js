...
async function initDataRetrieval() {
  try {
    ...
    checkOut.innerHTML = `<div class="check-out flex fd-col gap f-ai-c">
            ...
            <div class="your-info info-con">
              <div>
                ...
                <div class="flex f-ai-c gap">
                  ...
                  <div class="info-bar-con">
                    <h5 class="poppins">Email</h5>
                    <div class="info-bar uppercase poppins flex f-ai-c">
                      jane.doe@gmail.com
                    </div>
                  </div>
                </div>
            ...
            <div class="payment-info info-con">
              <div>
                <h4 class="uppercase poppins title-padding">
                  payment information
                </h4>
                <div class="flex f-ai-c gap">
                  ...
                  <div class="info-bar-con">
                    <div class="info-bar uppercase poppins flex f-ai-c f-jc-c">
                      <div class="flex gap">
                        <svg
                          width="64px"
                          height="64px"
                        ...
                        >
                          ...
                          <g
                            ...
                            stroke-linejoin="round"
                            stroke="#CCCCCC"
                            stroke-width="0.11599999999999999"
                          ></g>
                          <g
            ...
            <div class="buy-now-btn">
              <div class="buttons flex f-jc-c gap">
                <div
                  class="btn-sellers price flex f-jc-c f-ai-c"
